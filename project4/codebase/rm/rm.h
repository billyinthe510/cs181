...
#define INDEX_COL_ATTRIBUTE_NAME "idx-name"
#define INDEX_COL_FILE_NAME_SIZE 50
#define INDEX_RECORD_DATA_SIZE 1 + 3 * INT_SIZE + TABLES_COL_TABLE_NAME_SIZE + INDEX_COL_FILE_NAME_SIZE
...
private:
  ...
  void prepareIndexRecordData(int32_t id, const string &tableName, const string &attributeName, void* data);
